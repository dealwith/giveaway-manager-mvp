...
import { GIVEAWAY_STATUS_LABELS, GIVEAWAY_STATUS_COLORS } from '@/constants/giveaway';
...
export function GiveawayDetail({ giveaway, winners }: GiveawayDetailProps) {
  ...
  return (
    <div className="space-y-6">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will permanently cancel the giveaway. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete the giveaway and all associated data. This action cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          <CardContent className="space-y-4">
            ...
            {(isActive || isCompleted) && (
              <p className="text-sm text-gray-500 pt-2">
                Users who commented with <span className="font-medium">{giveaway.keyword}</span> will automatically receive a direct message with the prize document link.
              </p>
            )}

            {isScheduled && (
              <p className="text-sm text-gray-500 pt-2">
                This giveaway is scheduled to start on {format(new Date(giveaway.startTime), 'PPP p')}.
              </p>
            )}
      ...
      {winners.length > 0 && (
        <GiveawayWinnersList winners={winners} />
      )}
    </div>
  );
}